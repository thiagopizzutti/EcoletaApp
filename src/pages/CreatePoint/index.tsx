    ...
    <div id="page-create-point">
      ...
      <form action="">
        ...
        <fieldset>
          ...
          <Map center={[-23.2866258, -51.1173223]} zoom={15}>
            <TileLayer
              attribution='&amp;copy <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
              url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
            />
            <Marker position={[-23.2866258, -51.1173223]} />
          </Map>
          ...
          <div className="field-group">
            ...
            <div className="field">
              <label htmlFor="city">Estado (Cidade)</label>
              <select
                name="city"
                id="city"
                value={selectedCity}
